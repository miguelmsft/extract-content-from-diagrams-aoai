...
def main():  
    ...
    output_dir = Path('output_results_run4')  
    output_dir.mkdir(exist_ok=True)  
  
    # Define output images directory  
    output_images_dir = Path('output_images_run4')  
    output_images_dir.mkdir(exist_ok=True)  
  
    # Prompt to extract specific information  
    prompt = """Extract all the text and diagram from this image. Illustrate the diagram, along with the corresponding text, by drawing figures using text characters that represent the original image"""  
